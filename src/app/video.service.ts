...
export class VideoService {
  ...
  getVideo(id: string): Observable<Video> {
    const url = `https://www.googleapis.com/youtube/v3/search?key=AIzaSyAsMiGn7Z09Yh1zYyJlmPf0ak8XwZ7lFJY&channelId=UCcyq283he07B7_KUX07mmtA&order=date&part=snippet%20&type=video,id=${id}`;
